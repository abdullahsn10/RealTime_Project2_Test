...
void read_settings_from_a_file(char* filename) {
    ...
    while(fgets(line, sizeof(line), file) != NULL){
        ...
        else if(strcmp(label, "SPLITTING_RELIEF_COMMITTEES") == 0){
            SPLITTING_RELIEF_COMMITTEES = atoi(str);
        }
        else if(strcmp(label, "SPLITTING_RELIEF_WORKERS") == 0){
            SPLITTING_RELIEF_WORKERS = atoi(str);
        }
        else if(strcmp(label, "DISTRIBUTING_RELIEF_COMMITTEES") == 0){
            DISTRIBUTING_RELIEF_COMMITTEES = atoi(str);
        }
